...
class SingleChatTile extends StatelessWidget {
  const SingleChatTile({Key? key, required this.room,  this.darkText = false}) : super(key: key);
            ...
            Row(
              children: [
                ...
                Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(room.name ?? 'no name', style:  TextStyle(color: darkText ? Colors.black : Colors.white,fontSize: 18, fontWeight: FontWeight.bold),),
                    const SizedBox(height: 10,),
                    Text(globalRoomMap[room.id] ?? "chat now", style:  TextStyle(color: darkText ? Colors.black : Colors.white),),
                  ],
                ),
              ],
            ),
